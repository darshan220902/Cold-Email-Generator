...
def email_generate(job, links, name, company, designation, api_key):
    ...
    prompt_email = PromptTemplate.from_template(
        ...
        4. If not any portfolio provide print two messages **Either upload a valid csv or click checkbox else it is None**
...
st.markdown("""
    <div style='text-align: center;'>
        <p style='display: inline;'>
            ...
            Let's connect on 
            <a href='https://www.linkedin.com/in/your-profile' style='color: blue; text-decoration: none;'>LinkedIn</a>.
        </p>
    </div>
